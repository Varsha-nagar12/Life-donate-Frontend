                    ...
                    <div className="container">
                        <div className="row justify-content-start">
                            <div className="col-sm-10 col-lg-8">
                                ...
                                <h1 className="display-3 text-white animated slideInDown">The Best Online blood Donor Platform</h1>
                                <p className="fs-5 text-white mb-4 pb-2">Once a blood donor, always a lifesaver.
